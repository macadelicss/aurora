...
module ConvPy
  class Convert
    ...
    file_path = 'Downloads/updated_test_inv.csv'
    ...
    products_file_path = 'Projects/etherngin/products-txt.txt'
    ...
    products_export = CSV.read('/mnt/data/products_export_1.csv', headers: true)
    ...
    new_products_file_path = '/mnt/data/new_products.csv'
