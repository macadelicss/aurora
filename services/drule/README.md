...
To create your own page and have it show up in the app navigation, add a page inside app/routes, and a link to it in the <ui-nav-menu> component found in app/routes/app.jsx.
